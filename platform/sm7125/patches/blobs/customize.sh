...
LOG_STEP_IN "- Adding HWUI libs from a73xqxx"
...
LOG_STEP_IN "- Adding semSmartHS BPF from stock"
ADD_TO_WORK_DIR "$TARGET_FIRMWARE" "system" "system/etc/bpf/semSmartHS.o" 0 0 644 "u:object_r:system_lib_file:s0"
LOG_STEP_OUT
